...
plt.ylim(-10,10)
#plt.yticks(np.arange(-10, 22, step=5))
...
plt.savefig("plots/f06112_example-syncphase.eps")
plt.savefig("plots/f06112_example-syncphase.pdf")
plt.savefig("plots/f06112_example-syncphase.png")
